...
module.exports = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			'button',
			{ onClick: this.addLike, className: 'like' },
			this.props.model.get('likes'),
			' ',
			text
		);
	},
...
React.createElement(LikeButton, { model: model }), document.getElementById('button-goes-here'));

model.fetch();

},{"./components/LikeButton.js":160,"./models/LikeModel.js":162,"react":158}],162:[function(require,module,exports){
'use strict';
